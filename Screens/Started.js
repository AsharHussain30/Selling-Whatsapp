...
export const Started = () => {
  ...
  return (
    <CloseDropDown.Provider value={{showDropDown,setShowDropDown}}>
    <View style={{paddingTop: 10, backgroundColor: '#054d44', flex: 1}}>
      <TouchableOpacity
        ...
        <View
          style={{backgroundColor: '#054d44', alignItems: 'center', flex: 1}}>
          <Image
        ...
        {showHomePage == true ? (
          <>
            ...
            <View
              ...
              <View
                style={{justifyContent: 'space-evenly', top: 90, flex: 0.46}}>
                <Text
                  style={{
                    fontSize: 17,
                    paddingLeft: 45,
...
export const CloseDropDown = createContext();